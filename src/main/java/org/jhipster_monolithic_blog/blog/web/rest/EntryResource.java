...
import org.jhipster_monolithic_blog.blog.domain.Entry;

import org.jhipster_monolithic_blog.blog.repository.EntryRepository;
...
public class EntryResource {
    ...
    public ResponseEntity<List<Entry>> getAllEntries(@ApiParam Pageable pageable) {
        ...
        return new ResponseEntity<>(page.getConxtent(), headers, HttpStatus.OK);
    }
